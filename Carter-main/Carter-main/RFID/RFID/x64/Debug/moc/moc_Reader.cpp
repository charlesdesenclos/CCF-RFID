...
QT_MOC_LITERAL(1, 7, 7), // "hasRead"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 4), // "read"
QT_MOC_LITERAL(4, 21, 5), // "write"
QT_MOC_LITERAL(5, 27, 10) // "newContent"

    },
    "Reader\0hasRead\0\0read\0write\0newContent"
};
...
void Reader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Reader::*)(QMap<QString,QVariant> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Reader::hasRead)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Reader::hasRead(QMap<QString,QVariant> _t1)
{
